...
export function SystemStatusHud() {
  return (
    <div className="w-full bg-[#050c18]/80 backdrop-blur-md border-y border-white/10 py-2.5 px-4 text-xs font-mono text-[--muted] flex flex-wrap justify-between items-center gap-4">
